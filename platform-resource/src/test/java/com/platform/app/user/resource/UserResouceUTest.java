...
import com.platform.app.commontests.utils.ResourceDefinitions;
...
import static com.platform.app.commontests.user.UserTestUtils.getJsonWithEmailAndPassword;
import static com.platform.app.commontests.user.UserTestUtils.getJsonWithPassword;
import static com.platform.app.commontests.utils.FileTestNameUtils.getPathFileRequest;
import static com.platform.app.commontests.utils.FileTestNameUtils.getPathFileResponse;
import static com.platform.app.commontests.utils.JsonTestUtils.*;
...
public class UserResouceUTest {
    ...
    public void findByFilterNoFilter() {
        ...
        for (int i = 1; i <= allUsers.size(); i++) {
            users.add(userWithIdAndCreatedAt(allUsers.get(i - 1), (long) i));
        }
