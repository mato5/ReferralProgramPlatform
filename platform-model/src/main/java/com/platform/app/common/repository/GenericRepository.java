...
public abstract class GenericRepository<T> {
    ...
    @SuppressWarnings("unchecked")
    public List<T> findByIdBatch(List<Long> ids){
        return getEntityManager()
                .createQuery("Select e from " + getPersistentClass().getSimpleName() + " e where e.id in :incList")
                .setParameter("incList",ids).getResultList();
    }
